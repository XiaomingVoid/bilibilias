...
interface DownloadTaskDao {
    ...
    suspend fun updateTask(task: DownloadTask) {
        updateTaskRaw(task.copy(updateTime = currentTimeMillis()))
    }
    ...
    suspend fun updateNode(node: DownloadTaskNode) {
        updateNodeRaw(node.copy(updateTime = currentTimeMillis()))
    }
    ...
    suspend fun updateSegment(segment: DownloadSegment) {
        updateSegmentRaw(segment.copy(updateTime = currentTimeMillis()))
    }
