package com.imcys.bilibilias.shared.feature.setting.about
...
import com.imcys.bilibilias.shared.util.ASConstant
    ...
    Row(
        ...
        Surface(
            ...
            onClick = {
                ...
                openLink(ASConstant.QQ_CHANNEL_URL)
            }
        ) {
            Icon(
        ...
        Surface(
            ...
            onClick = {
                haptics.performHapticFeedback(HapticFeedbackType.ContextClick)
                openLink(ASConstant.QQ_GROUP_URL)
            }
        ) {
            Icon(
...
fun IconArea() {
    Icon(
        modifier = Modifier
            .padding(4.dp)
            .size(60.dp),
        painter = painterResource(Res.drawable.ic_logo_mini),
