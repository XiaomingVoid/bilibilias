package com.imcys.bilibilias.shared.feature.download
...
import bilibilias.shared.generated.resources.common_delete
import bilibilias.shared.generated.resources.download_batch_delete_title
import bilibilias.shared.generated.resources.download_delete_confirm_message
import bilibilias.shared.generated.resources.download_deselect_all
import bilibilias.shared.generated.resources.download_select_all
import bilibilias.shared.generated.resources.status_completed_title
import bilibilias.shared.generated.resources.status_downloading_title
...
import com.imcys.bilibilias.shared.platform.storage.FileInfo
import com.imcys.bilibilias.shared.platform.storage.FileSystem.openFile
...
import com.imcys.bilibilias.shared.ui.component.DownloadFinishTaskCard
...
private fun openFile(segment: DownloadSegment) {
    val result = openFile(FileInfo(segment.savePath))
    if (!result) {
...
private fun DeleteConfirmDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(Res.string.download_batch_delete_title)) },
...
private fun PageChangeTools(
    ...
    Row(
        ...
        ToggleButton(
            ...
            Text(stringResource(Res.string.status_downloading_title))
        }
        ...
        ToggleButton(
            ...
            Text(stringResource(Res.string.status_completed_title))
        }
...
private fun EditTopTools(
    ...
    Row(
        ...
        OutlinedButton(
            ...
            Text(stringResource(Res.string.download_deselect_all))
        }
        ...
        OutlinedButton(
            ...
            Text(stringResource(Res.string.download_select_all))
        }
