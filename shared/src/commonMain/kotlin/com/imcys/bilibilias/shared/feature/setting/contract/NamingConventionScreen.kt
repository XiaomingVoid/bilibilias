package com.imcys.bilibilias.shared.feature.setting.contract
    ...
    Surface(
        ...
        Column(
            ...
            AnimatedVisibility(ruleValue != defaultRule) {
                ASWarringTip {
                    Text(stringResource(Res.string.setting_naming_warning))
                }
            }
            OutlinedTextField(
                ...
                label = { Text(stringResource(Res.string.setting_naming_convention)) },
                modifier = Modifier
                    .fillMaxWidth()
                    .onFocusChanged {
