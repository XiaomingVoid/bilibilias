package com.imcys.bilibilias.shared.feature.analysis.components
...
import bilibilias.shared.generated.resources.analysis_ai_beta_notice
import bilibilias.shared.generated.resources.analysis_ai_translation
import bilibilias.shared.generated.resources.analysis_cache_preference
import bilibilias.shared.generated.resources.analysis_select_interactive_video
import bilibilias.shared.generated.resources.analysis_select_part_video
...
import com.imcys.bilibilias.ui.component.ASCommonSelectGrid
import com.imcys.bilibilias.ui.component.shimmer.shimmer
import com.imcys.bilibilias.ui.component.tip.ASErrorTip
import com.imcys.bilibilias.ui.component.tip.ASWarringTip
import com.imcys.bilibilias.ui.component.ASCommonExposedDropdownMenu
import com.imcys.bilibilias.shared.ui.component.ASEpisodeSelection
import com.imcys.bilibilias.shared.ui.component.ASEpisodeTitle
import com.imcys.bilibilias.shared.ui.component.ASSectionEpisodeSelection
import com.imcys.bilibilias.shared.ui.component.AsAutoError
import com.imcys.bilibilias.shared.ui.component.OnUpdateEpisodeListMode
    ...
    SurfaceColorCard {
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(stringResource(Res.string.analysis_cache_preference))
...
fun BILIAISimultaneousInterpretation(
    ...
    Column(
        ...
        Text(stringResource(Res.string.analysis_ai_translation))
        AnimatedVisibility(
            visible = selectAudioLanguage != null
        ) {
            Spacer(Modifier.height(6.dp))
            ASWarringTip {
                Text(stringResource(Res.string.analysis_ai_beta_notice))
            }
        }
        Spacer(Modifier.height(6.dp))
        ASCommonSelectGrid(
...
fun InteractiveVideoPageScreen(
    ...
    Column {
        Text(stringResource(Res.string.analysis_select_interactive_video))
        ASEpisodeTitle(
            stringResource(Res.string.analysis_select_interactive_video),
            episodeListMode = episodeListMode,
            isSelectSingleModel = isSelectSingleModel,
            onUpdateEpisodeListMode = onUpdateEpisodeListMode,
            onSelectAllClick = {
    ...
    epVideoList.takeIf { it.isNotEmpty() }?.let { episodes ->
        ...
        ASCommonExposedDropdownMenu(
            text = episodes.firstOrNull { it.id == selectEpisodeId }?.title
                ?: "",
            label = stringResource(Res.string.analysis_select_part_video),
            values = episodes,
            onValue = { it.title },
            onSelect = {
