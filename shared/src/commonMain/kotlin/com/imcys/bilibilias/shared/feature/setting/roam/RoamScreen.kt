package com.imcys.bilibilias.shared.feature.setting.roam
...
import bilibilias.shared.generated.resources.*
...
import com.imcys.bilibilias.ui.component.ASCheckThumbSwitch
...
import com.imcys.bilibilias.ui.component.BannerItem
import com.imcys.bilibilias.ui.component.TipSettingsItem
import com.imcys.bilibilias.ui.component.tip.ASErrorTip
import com.imcys.bilibilias.ui.component.tip.ASInfoTip
import com.imcys.bilibilias.ui.component.tip.ASWarringTip
import com.imcys.bilibilias.ui.component.ASCommonLoadingScreen
...
private fun RoamSettingErrorScreen(errorMsg: String) {
    Column(
        ...
        Text(stringResource(Res.string.roam_load_failed_format, errorMsg), fontSize = 16.sp)
        Button(
...
private fun ApplyPendingTip(applyRoamContent: String) {
    ASInfoTip {
        Text(stringResource(Res.string.roam_pending_review))
    }
    ...
    Surface(
        ...
        Column(
            ...
            Text(stringResource(Res.string.roam_application_content))
...
private fun ApplyForm(
    ...
    if (isRejected) {
        ASErrorTip {
            Text(stringResource(Res.string.roam_rejected_format, rejectReason ?: stringResource(Res.string.roam_test_failed)))
        }
    } else {
        ASWarringTip {
            Text(stringResource(Res.string.roam_not_applied))
        }
    }
...
private fun ApplyFormEditor(value: String, onValueChange: (String) -> Unit) {
    OutlinedTextField(
        ...
        label = { Text(stringResource(Res.string.roam_application_reason)) },
        minLines = 4,
    )
}
    ...
    Button(
        ...
        Row(
            ...
            if (isLoading) {
                ...
                Text(stringResource(Res.string.roam_submit_application))
            }
        }
    }
...
private fun RoamSettingSuccessScreen(
    ...
    BannerItem {
        Row(
            ...
            Text(stringResource(Res.string.roam_enable_roam), fontSize = 18.sp)
            ...
            ASTopAppBar(
                ...
                title = {
                    BadgedBox(
                        badge = {
                            Badge {
                                Text(stringResource(Res.string.common_beta))
                            }
                        }
                    ) {
                        Text(text = "漫游服务")
