package com.imcys.bilibilias.shared.feature.event.playvoucher
...
import bilibilias.shared.generated.resources.play_voucher_error_title
    ...
    Scaffold(
        topBar = {
            ASTopAppBar(
                ...
                title = { Text(stringResource(Res.string.play_voucher_error_title)) },
        ...
        Column(
            ...
            Button(
                ...
                Text(stringResource(Res.string.common_i_know))
            }
        }
    }
}