...
import bilibilias.shared.generated.resources.analysis_select_audio_quality
import bilibilias.shared.generated.resources.analysis_select_codec
import bilibilias.shared.generated.resources.analysis_select_resolution
...
fun AudioQualitySelectScreen(
    ...
    if (!audioList.isNullOrEmpty() || apiStatus != ApiStatus.SUCCESS) {
        ASCommonExposedDropdownMenu(
            ...
            label = stringResource(Res.string.analysis_select_audio_quality),
...
fun VideoSupportFormatsSelectScreen(
    ...
    Row(
        ...
        ASCommonExposedDropdownMenu(
            ...
            label = stringResource(Res.string.analysis_select_resolution),
        ...
        if (videoCodingList.isNotEmpty()) {
            ASCommonExposedDropdownMenu(
                ...
                label = stringResource(Res.string.analysis_select_codec),
